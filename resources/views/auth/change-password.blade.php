                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('change.perform') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Alterar senha</button>
                                        </div>
                                    </form>
                                </div>
                                <div id="alert">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('./img/fe2.png');
              background-size: cover;">
                                <span class="mask bg-gradient-primary opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">Portanto, exortem-se e edifiquem-se uns aos outros, como de fato vocês estão fazendo.
                                     - 1 Tessalonicenses 5:11 </h4>
                                <p class="text-white position-relative">Nossa missão é simples, mas poderosa:
                                    orar pelos corações necessitados, trazendo paz e fé.</p>
                            </div>
                        </div>
                    </div>
                </div>
